            ...
            <div className="flex flex-col gap-[20px]">
                <div className="flex flex-row text-sm gap-4">
                    <div className="bg-zinc-800 p-4 rounded-2xl shadow-lg">
                        ...
                        <p>We met Egor “randomly” (so we thought).  We had our high schoolers in overpriced commercialized tutoring facilities that was not helping them much. Egor is incredibly smart and understanding. He will take his time and meet the student at their levels.  He is patient and very kind. If you need a math Tutor he is your guy. I thank God for allowing us to meet Egor “randomly”. Thanks Egor!</p>
                    </div>
                    <div className="bg-zinc-800 p-4 rounded-2xl shadow-lg">
                ...
                <div className="flex flex-row text-sm gap-4">
                    <div className="bg-zinc-800 p-4 rounded-2xl shadow-lg">
                        ...
                        <p>I finally understood math with this tutor. Math has always been difficult for me, especially on the SAT, but he helped me improve my score to (blank) and achieve a high result. We had tutoring sessions twice a week, and he created a personalized program to cover the gaps in what I missed during school lessons. He also provided a lot of practice assignments that were really helpful and hard to find anywhere else. I highly recommend him because, thanks to his help, I no longer feel afraid of math and was able to achieve a high score.</p>
                    </div>
                </div>
